...
| [docs/telegram-topic-routing.md](docs/telegram-topic-routing.md) | Telegram forum topic routing for shared sessions — design, cross-mount DB gotchas, rebase notes |
